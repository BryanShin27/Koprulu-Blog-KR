...
* 시즈 탱크 시즈 모드의 사거리가 13에서 14로 증가하였습니다.
...
* 실드 배터리의 실드 재충전 능력이 스타1과 유사하도록 수정하였습니다. (자동 시전 불가, 초당 112의 실드 충전)
...
* 기본 가속도가 1.0625에서 1.2로 증가하였습니다.
* 중력 구동기 연구가 가속도를 추가로 0.75 증가시킵니다.
...
* 공격 주기가 0.9375에서 1.0375로 증가하였습니다.
...
* 무기 선딜레이가 0.33에서 0.25로 감소하였습니다. __(코어)__
